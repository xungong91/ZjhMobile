...
bool js_cocos2dx_nativehelper_NativeHelper_recvJsMsg(JSContext *cx, uint32_t argc, jsval *vp)
{
    ...
    JSB_PRECONDITION2( cobj, cx, false, "js_cocos2dx_nativehelper_NativeHelper_recvJsMsg : Invalid Native Object");
    if (argc == 2) {
        std::string arg0;
        int arg1;
        ok &= jsval_to_std_string(cx, args.get(0), &arg0);
        ok &= jsval_to_int32(cx, args.get(1), (int32_t *)&arg1);
        JSB_PRECONDITION2(ok, cx, false, "js_cocos2dx_nativehelper_NativeHelper_recvJsMsg : Error processing arguments");
        bool ret = cobj->recvJsMsg(arg0, arg1);
    ...
    JS_ReportError(cx, "js_cocos2dx_nativehelper_NativeHelper_recvJsMsg : wrong number of arguments: %d, was expecting %d", argc, 2);
    return false;
}
