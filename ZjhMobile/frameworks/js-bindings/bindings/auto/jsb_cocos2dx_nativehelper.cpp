...
bool js_cocos2dx_nativehelper_NativeHelper_setCallFunc(JSContext *cx, uint32_t argc, jsval *vp)
{
    ...
    js_proxy_t *proxy = jsb_get_js_proxy(obj);
    cocos2d::NativeHelper* cobj = (cocos2d::NativeHelper *)(proxy ? proxy->ptr : NULL);
    JSB_PRECONDITION2( cobj, cx, false, "js_cocos2dx_nativehelper_NativeHelper_setCallFunc : Invalid Native Object");
    if (argc == 1) {
		...
		;
        JSB_PRECONDITION2(ok, cx, false, "js_cocos2dx_nativehelper_NativeHelper_setCallFunc : Error processing arguments");
        cobj->setCallFunc(arg0);
